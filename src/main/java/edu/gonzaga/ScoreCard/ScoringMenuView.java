...
public class ScoringMenuView extends JPanel{
    ...
    private GameLabel menuExplanation1;
    ...
    public void setComponentLocations(){
        menuExplanation1.setLocation(10, 0);
        menuExplanation2.setLocation(10, 20);
        for(int i = 0; i < 6; i++){
            buttons.get(i).setLocation(10, (45 + rowHeight * i));
        }
        for(int i = 6; i < buttons.size(); i++){
            buttons.get(i).setLocation(10, (45 + (4 * rowHeight) + rowHeight * i));
        }
    }

    public void AddComponents(){
        this.add(menuExplanation1);
